...
class Client(Iface):
  ...
  def GetSearchResult(self, request):
    ...
    Parameters:
     - request
    """
    self.send_GetSearchResult(request)
    return self.recv_GetSearchResult()

  def send_GetSearchResult(self, request):
...
class Processor(Iface, TProcessor):
  ...
  def process_GetSearchResult(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = GetSearchResult_result()
    result.success = self._handler.GetSearchResult(args.request)
    oprot.writeMessageBegin("GetSearchResult", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class GetSearchResult_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'request', (HyySearchRequest, HyySearchRequest.thrift_spec), None, ), # 1
  )
...
class GetSearchResult_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (HyySearchResponse, HyySearchResponse.thrift_spec), None, ), # 0
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 0:
        if ftype == TType.STRUCT:
          self.success = HyySearchResponse()
